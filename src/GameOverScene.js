...
export default class GameOverScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(centerX, height * 0.14, "Игра окончена", {
            fontSize: "44px",
            color: "#f1c40f",
            fontStyle: "bold"
        }).setOrigin(0.5);
        ...
        if (this.winner) {
            this.add.text(centerX, height * 0.24, `Победитель: ${this.winner.name}`, {
                fontSize: "30px",
            ...
            this.add.text(centerX, height * 0.24, "Ничья!", {
                fontSize: "34px",
                color: "#ecf0f1",
                fontStyle: "bold"
            }).setOrigin(0.5);
        ...
        this.players.forEach((player, index) => {
            ...
            this.add.text(x, height * 0.62, `${player.name}: ${player.gold} 🪙`, {
                fontSize: "24px",
        ...
        this.add.text(centerX, buttonY, "Начать заново", {
            fontSize: "24px",
            color: "#ffffff",
            fontStyle: "bold"
        }).setOrigin(0.5);
